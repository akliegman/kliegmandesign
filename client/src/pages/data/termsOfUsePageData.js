export const termsOfUsePageData = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "text",
        content: `), concerning your access to and
        use of the adamkliegman.com website as well as any other
  ...
  {
    type: "paragraph",
    content: `Supplemental terms and conditions or documents that may be posted on
  ...
  {
    type: "paragraph",
    content: `The information provided on the Site is not intended for distribution
  ...
  {
    type: "paragraph",
    content: `The Site is intended for users who are at least 18 years old. Persons
  ...
  {
    type: "paragraph",
    content: `Unless otherwise indicated, the Site is our proprietary property and all
  ...
  {
    type: "paragraph",
    content: `Provided that you are eligible to use the Site, you are granted a
  ...
  {
    type: "paragraph",
    content: `By using the Site, you represent and warrant that: (1) all
  ...
  {
    type: "paragraph",
    content: `If you provide any information that is untrue, inaccurate, not
  ...
  {
    type: "paragraph",
    content: `You may be required to register with the Site. You agree to keep your
  ...
  {
    type: "paragraph",
    content: `You may not access or use the Site for any purpose other than that for
  ...
  },
  {
    ...
    content: [
      {
        type: "list-item",
        content: `Systematically retrieve data or other content from the Site to
      ...
      {
        type: "list-item",
        content: `Make any unauthorized use of the Site, including collecting
      ...
      {
        type: "list-item",
        content: `Use a buying agent or purchasing agent to make purchases on
            the Site.`,
      },
      {
        type: "list-item",
      ...
      {
        type: "list-item",
        content: `Circumvent, disable, or otherwise interfere with security
            related features of the Site, including features that prevent or
      ...
      {
        type: "list-item",
        content: `Trick, defraud, or mislead us and other users, especially in
            any attempt to learn sensitive account information such as
            user passwords;`,
      },
      {
        type: "list-item",
        content: `Make improper use of our support services or submit false
      ...
      {
        type: "list-item",
        content: `Use any information obtained from the Site in order to harass,
            abuse, or harm another person.`,
      },
      {
        type: "list-item",
        content: `Decipher, decompile, disassemble, or reverse engineer any of
            the software comprising or in any way making up a part of the
            Site.`,
      },
      {
        type: "list-item",
        content: `Attempt to bypass any measures of the Site designed to prevent
            or restrict access to the Site, or any portion of the Site.`,
      },
      {
        type: "list-item",
        content: `Harass, annoy, intimidate, or threaten any of our employees
            or agents engaged in providing any portion of the Site to you.`,
      },
      {
        type: "list-item",
        content: `Delete the copyright or other proprietary rights notice from
            any Content.`,
      },
      {
        type: "list-item",
        content: `Upload or transmit (or attempt to upload or to transmit)
      ...
      {
        type: "list-item",
        content: `Upload or transmit (or attempt to upload or to transmit) any
      ...
      {
        type: "list-item",
        content: `Except as may be the result of standard search engine or
      ...
      {
        type: "list-item",
        content: `Disparage, tarnish, or otherwise harm, in our opinion, us and/or
            the Site.`,
      },
      {
        type: "list-item",
        content: `Use the Site in a manner inconsistent with any applicable laws
            or regulations.`,
      },
    ],
  },
  ...
  {
    type: "paragraph",
    content: `The Site may invite you to chat, contribute to, or participate in
  ...
  {
    type: "paragraph",
    content: `When you create or make available any Contributions, you thereby
  ...
  },
  {
    ...
    content: [
      {
        type: "list-item",
        content: `The creation, distribution, transmission, public display, or
      ...
      {
        type: "list-item",
        content: `You are the creator and owner of or have the necessary
      ...
      {
        type: "list-item",
        content: `You have the written consent, release, and/or permission of
      ...
      {
        type: "list-item",
        content: `Your Contributions are not unsolicited or unauthorized
            advertising, promotional materials, pyramid schemes, chain
            letters, spam, mass mailings, or other forms of solicitation.`,
      },
      {
        type: "list-item",
        content: `Your Contributions are not obscene, lewd, lascivious, filthy,
            violent, harassing, libelous, slanderous, or otherwise
            objectionable (as determined by us).`,
      },
      {
        type: "list-item",
        content: `Your Contributions do not ridicule, mock, disparage, intimidate,
            or abuse anyone.`,
      },
      {
        type: "list-item",
        content: `Your Contributions are not used to harass or threaten (in the
            legal sense of those terms) any other person and to promote
            violence against a specific person or class of people.`,
      },
      {
        type: "list-item",
        content: `Your Contributions do not violate any applicable law,
            regulation, or rule.`,
      },
      {
        type: "list-item",
        content: `Your Contributions do not violate the privacy or publicity
            rights of any third party.`,
      },
      {
        type: "list-item",
        content: `Your Contributions do not contain any material that solicits
  ...
  {
    type: "paragraph",
    content: `You acknowledge and agree that any questions, comments,
  ...
  {
    type: "paragraph",
    content: `The Site may contain (or you may be sent through the Site) links
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "list-item",
        content: `Take appropriate legal action against anyone who, in our
      ...
      {
        type: "list-item",
        content: `In our sole discretion and without limitation, refuse,
      ...
      {
        type: "list-item",
        content: `In our sole discretion and without limitation, notice,
      ...
      {
        type: "list-item",
        content: `Otherwise manage the Site in a manner designed to protect
  ...
  {
    type: "paragraph",
    content: `We care about data privacy and security. By using the Site, you
  ...
  {
    type: "paragraph",
    content: `These Terms of Use shall remain in full force and effect while
  ...
  {
    type: "paragraph",
    content: `If we terminate or suspend your account for any reason, you are
  ...
  {
    type: "paragraph",
    content: `We reserve the right to change, modify, or remove the contents
  ...
  {
    type: "paragraph",
    content: `We cannot guarantee the Site will be available at all times.
        ...
        Site at any time or for any reason without notice to you. You
        ...
        Site during any downtime or discontinuance of the Site. Nothing
  ...
  {
    type: "paragraph",
    content: `Our failure to enforce any right or provision of these Terms
        ...
        our Site, and supersede and replace any prior agreements we might
        have had between us regarding the Site.`,
  },
  {
    type: "heading-2",
  ...
  {
    type: "paragraph",
    content: `The formation, interpretation, and performance of these Terms
        ...
        jurisdiction for any claims arising out of or relating to these
        Terms or the Site shall be the state and federal courts located
        within New York County, New York. You waive any and all
  ...
  {
    type: "paragraph",
    content: `There may be information on the Site that contains typographical
        ...
        to change or update the information on the Site at any time, at
        our sole discretion.`,
  },
  {
    type: "heading-2",
  ...
  {
    type: "paragraph",
    content: `THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU
  ...
  {
    type: "paragraph",
    content: `IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE
  ...
  {
    type: "paragraph",
    content: `You agree to defend, indemnify, and hold us harmless, including
        ...
        in these Terms; (4) your violation of the rights of a third
        party, including but not limited to intellectual property
        rights; or (5) any overt harmful act toward any other user of
        the Site with whom you connected via the Site. Notwithstanding
  ...
  {
    type: "paragraph",
    content: `We will maintain certain data that you transmit to the Site for
  ...
  {
    type: "paragraph",
    content: `Visiting the Site, sending us emails, and completing online
  ...
  {
    type: "paragraph",
    content: `If any complaint with us is not satisfactorily resolved, you can
  ...
  {
    type: "paragraph",
    content: `These Terms and Conditions and any policies or operating rules
        ...
        part of a provision of these Terms and Conditions is determined
        to be unlawful, void, or unenforceable, that provision or part of
        the provision is deemed severable from these Terms and
        ...
        you and us as a result of these Terms and Conditions or use of
